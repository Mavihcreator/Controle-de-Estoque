...
if (currentUser.role !== 'COLAB') {
    // Redirecionar para uma página de acesso não autorizado ou fazer algo apropriado para outras roles.
    // Exemplo:
...
document.addEventListener'DOMContentLoaded', () => {
    ...
    const generateReport = (days) => {
        ...
        if (reportData.length > 0) {
            ...
            reportOutput.textContent = 'Nenhum produto próximo da validade nos próximos 7 dias'
        }
